...
FLAGS = --pdf-engine=tectonic -f markdown -V geometry:margin=0.3in -V urlcolor:blue -V linestretch:0.9 -V fontsize:5pt -V pagestyle=empty --template template.latex
